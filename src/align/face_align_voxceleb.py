...
if __name__ == '__main__':
    ...
    parser.add_argument("-source_root", "--source_root", help="specify your source dir", default="../../data/fiw-mm/", type=str)
    parser.add_argument("-dest_root", "--dest_root", help="specify your destination dir", default="../../data/fiw-mm/features/visual/video/", type=str)
    ...
    for f_video in tqdm(f_videos):
        ...
        if ndetections == 0:  # If the landmarks cannot be detected, the img will be discarded
        ...
        for i in range(ndetections):
            ...
            image_name = imfile.replace('images', 'cropped').replace(".jpg", "-{:02d}.jpg".format(i))
